package com.ezbuy.app.detail.customview
...
import com.ezbuy.app.detail.adapter.OtherProductsAdapter
import com.ezbuy.app.detail.adapter.ProductOptionsAdapter
import com.ezbuy.domain.model.detail.DetailModel
import com.ezbuy.app.databinding.LayoutDetailProductContentBinding
...
class DetailProductContent(context: Context, attrs: AttributeSet? = null) :
    ...
    private val binding: LayoutDetailProductContentBinding =
        LayoutDetailProductContentBinding.inflate(LayoutInflater.from(context), this)
